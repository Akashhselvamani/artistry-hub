      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            <h3 className="font-serif text-2xl mb-4">Artist Agency</h3>
            <p className="text-background/70 font-sans leading-relaxed max-w-md">
              Where creativity blooms and talent finds its voice. Representing artists 
              who inspire, move, and redefine beauty and art.
            </p>
          </div>
          ...
          {/* Social */}
          <div>
            <h4 className="font-sans font-medium mb-4 text-background/90">Follow Us</h4>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-background/10 flex items-center justify-center hover:bg-background/20 transition-colors duration-300">
        ...
        <div className="pt-8 border-t border-background/10 text-center">
          <p className="text-background/50 font-sans text-sm">
            © 2024 Artist Agency. All rights reserved. Crafted with passion.
          </p>
        </div>
      </div>
    </footer>
